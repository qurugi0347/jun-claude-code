...
|------|------|
| Summary | 1-2줄 |
| Why / What / How / 사이드 이펙트 | 각 3줄 이내 |
| 주요 변경사항의 변경별 내용 | 1-2줄 |

```markdown
## 📋 Summary

> 1-2줄: PR이 해결하는 문제와 접근 방식

## 🎯 Why (의도)

> 3줄 이내: 변경이 필요한 배경과 동기

## 🐛 What (문제)

> 3줄 이내: 해결하려는 구체적 문제/증상

## 🔧 How (해결 방법)

> 3줄 이내: 접근 방식과 핵심 변경 내용
